...
export default class MyMatloop extends Component {
  ...
  constructor(props) {
   ...
   updateadd(){
    ...
    //alert(id)
   this.props.navigation.navigate("UpdateWanted",{Key:id})
  }
  Deactivate(){
  ...
  //alert(userObj.image)
   ...
   ProGetData=()=>{
      ...
      <View style={{paddingTop: 15,}}>
            ...
            <Text style={{width:'50%', fontFamily:'ElMessiri-Regular'}}> المدينة / الولاية  </Text>
            </View>
